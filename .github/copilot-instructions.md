...
This file (`.github/copilot-instructions.md`) is the **source of truth** for agent guidance in this repo. `AGENTS.md`, `CLAUDE.md`, and `GEMINI.md` at the repo root are symlinks to it — edit this file, not the symlinks.
